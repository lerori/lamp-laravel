...
<head>
    ...
    <meta name="description" content="Desarrollo de Sistemas - Servidores - Asesoramiento">
    <meta name="author" content="AUTOSoft - Leo Riccieri">
    <meta name="twitter:site" content="@leodesist" />
    <meta name="twitter:creator" content="@leodesist" />

    <title>{{ trans('adminlte_lang::message.landingdescription') }}</title>
    ...
    <div id="navigation" class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#"><b>AUTOSoft y Asoc.</b></a>
            </div>
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    <li class="active"><a href="#inicio" class="smoothScroll">{{ trans('adminlte_lang::message.home') }}</a></li>                    
                    <li><a href="#servicios" class="smoothScroll">{{ trans('adminlte_lang::message.service') }}</a></li>
                    <li><a href="#nosotros" class="smoothScroll">{{ trans('adminlte_lang::message.aboutus') }}</a></li>
                    <li><a href="#contacto" class="smoothScroll">{{ trans('adminlte_lang::message.contact') }}</a></li>
                </ul>
...
<!-- From here Insert content web page  -->
    ...
    <div id="headerwrap">
        <div class="container">
            ...
            <div class="row centered">
                <div class="col-lg-12">
                    <h1>Gestión comercial <b><a href="https://github.com/acacha/adminlte-laravel">AUTOweb v1.2</a></b></h1>
                    <h3>{{ trans('adminlte_lang::message.laravelpackage0') }} <a href="https://laravel.com/">Laravel 5</a> {{ trans('adminlte_lang::message.laravelpackage') }}
                        {{ trans('adminlte_lang::message.to') }} <a href="https://almsaeedstudio.com/preview">AdminLTE</a> {{ trans('adminlte_lang::message.templatewith') }}
    ...
    <section id="nosotros" name="nosotros"></section>
    <div id="showcase">
        <div class="container">
            <div class="row">
    ...
    <div id="c">
        <div class="container">
            <p>
                <a href="https://autosoft.com.ar"></a><b>Copyright&copy; 2018 by AUTOSoft y Asoc. All Rights Reserved</b></a><br/>
                <strong>Packaged for Laravel by <a href="http://acacha.org/sergitur"> Sergi Tur Badenas</a></strong> - {{ trans('adminlte_lang::message.seecode') }} <a href="https://github.com/acacha/adminlte-laravel"> Github</a>
                <br/>
